...
open class EmotionalFaceView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private fun setupAttributes(attrs: AttributeSet?) {
        ...
        borderWidth = typedArray.getDimension(
            R.styleable.EmotionalFaceView_borderWith,
